 ...
 if($answer_exists_result == true)
    {
        ...
        if(!(in_array(true, $check_nulls)))
        {
            ...
            editQuestion($app, $cleaned_parameters, $question_id);
 ...
 */
function editQuestion($app, $cleaned_parameters, $question_id)
{
    ...
    $verification = $model->addQuestion($question_id, $cleaned_quizid, $cleaned_question, $cleaned_choice_1, $cleaned_choice_2, $cleaned_choice_3, $cleaned_choice_4, $cleaned_answer);
