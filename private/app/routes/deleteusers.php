...
/**
 *  deleteusers.php - Fetches form deleteuser.html.twig and outputs stored variables to it.
...
/** Fetches all users except the current user from the database using relevant method from RoleModel.
 *
 * @param $username
 * @param $app
 * @return mixed
 */
function getUsers($username, $app)
{
    ...
    $users = $model->retrieveUsersFromDB($username);
